...
(
	...
	opprettet DATETIME NOT NULL,
	CONSTRAINT pk_reise PRIMARY KEY (reiseId),
	CONSTRAINT fk_reise1 FOREIGN KECREATE TABLE statusKode
(
	statusKodeId INT NOT NULL AUTO_INCREMENT, 
	navn VARCHAR(45),
	endret TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
Y (reiseTypeId) REFERENCES reiseType (reiseTypeId),
	CONSTRAINT fk_reise2 FOREIGN KEY (statusKodeId) REFERENCES statusKode (statusKodeId)
);
...
// DROP TABLE billettType, fly, flyplass, reiseType, reise, kunde, flyvningsType, flyvning, destinasjon, brukerType, 
bruker, rute, pris, prishistorikk, billett, statusKode, logg, autentisering;